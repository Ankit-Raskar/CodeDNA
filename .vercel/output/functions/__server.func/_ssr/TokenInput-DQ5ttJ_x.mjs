...
import { D as FiKey, E as FiHelpCircle, F as FiSearch, H as FiTrash2, K as FiX, P as FiRefreshCw, R as FiShield, U as FiTrendingUp, W as FiUser, b as FiEye, c as FiCheck, l as FiCheckCircle, m as FiClock, n as FiAlertCircle, p as FiClipboard, q as FiZap, u as FiChevronDown, x as FiEyeOff, y as FiExternalLink } from "../_libs/react-icons.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/TokenInput-DQ5ttJ_x.js
...
function SearchBar({ initial = "", compact = false }) {
	...
	(0, import_react.useEffect)(() => {
		const onClick = (e) => {
			if (formRef.current && !formRef.current.contains(e.target)) setFocused(false);
		};
	...
	const saveRecent = (username) => {
		...
		setRecent(list);
		try {
			localStorage.setItem("codedna_recent", JSON.stringify(list));
		} catch {}
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.form, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: `card-soft relative z-20 flex w-full items-center gap-2 rounded-full p-2 pl-5 ring-soft transition-all ${focused ? "ring-2 ring-primary/50 shadow-[0_0_30px_rgba(99,102,241,0.2)] bg-card" : ""}`,
			children: [
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: focused && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			initial: {
				opacity: 0,
				y: -10,
				scale: .98
			...
			children: v ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid h-8 w-8 place-items-center rounded-full bg-primary/20 text-primary",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiUser, { className: "h-4 w-4" })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "text-sm font-medium text-foreground",
					children: ["Analyze @", v]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "text-xs text-muted-foreground",
					children: "Press Enter to decode DNA"
				})] })]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [recent.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
					className: "mb-2 flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiClock, {}), " Recent Searches"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex flex-col gap-1",
					children: recent.map((u) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiTrendingUp, {}), " Trending Developers"]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex flex-wrap gap-2",
				children: TRENDING.map((u) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					onClick: () => selectUser(u),
	...
	return (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mb-1 inline-flex h-11 w-11 items-center justify-center rounded-2xl grad-primary text-xl text-foreground shadow-lg",
					children: "🔑"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
					...
					children: STEPS.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "grid h-7 w-7 shrink-0 place-items-center rounded-full grad-primary text-xs font-bold text-foreground",
							children: i + 1
