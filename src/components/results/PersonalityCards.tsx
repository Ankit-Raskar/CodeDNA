...
const META: Array<{ key: keyof AIInsights["personalities"]; label: string; emoji: string; grad: string; bg: string }> = [
  ...
  { key: "weapon", label: "Weapon", emoji: "⚔️", grad: "from-slate-500 to-zinc-700", bg: "from-slate-50 to-zinc-50" },
  { key: "movie", label: "Movie", emoji: "🎬", grad: "from-pink-500 to-purple-600", bg: "from-pink-50 to-purple-50" },
];
